...
class TestRegisterNewUser:
    def test_register_new_user_with_valid_data(self, app):
        ...
        res = app.register.register_new_user(
    ...
    def test_register_new_user_with_empty_data(self, app, field):
        """
        ...
        res = app.register.register_new_user(data=data, type_response=MessageResponse)
